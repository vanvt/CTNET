  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-suitcase"></i> <span>Product</span></a>
          <ul class="children">
            <li><a href="graphs.html"><i class="fa fa-caret-right"></i> Add New</a></li>
            <li><a href="widgets.html"><i class="fa fa-caret-right"></i> Update</a></li>
            <li><a href="extras.html"><i class="fa fa-caret-right"></i> Delete</a></li>
          </ul>
        </li>
        
		<li class="nav-parent"><a href="#"><i class="fa fa-suitcase"></i> <span>Page</span></a>
          <ul class="children">
			<li><a href="graphs.html"><i class="fa fa-caret-right"></i> Add New</a></li>
            <li><a href="widgets.html"><i class="fa fa-caret-right"></i> Update</a></li>
            <li><a href="extras.html"><i class="fa fa-caret-right"></i> Delete</a></li>
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-suitcase"></i> <span>User</span></a>
          <ul class="children">
			<li><a href="graphs.html"><i class="fa fa-caret-right"></i> Add New</a></li>
            <li><a href="widgets.html"><i class="fa fa-caret-right"></i> Update</a></li>
            <li><a href="extras.html"><i class="fa fa-caret-right"></i> Delete</a></li>
        ...
        <li><a href="tables.html"><i class="fa fa-th-list"></i> <span>Setting</span></a></li>
        
         <li class="nav-parent"><a href="#"><i class="fa fa-suitcase"></i> <span>Upload</span></a>
          <ul class="children">
			<li><a href="graphs.html"><i class="fa fa-caret-right"></i> Add New</a></li>
            <li><a href="widgets.html"><i class="fa fa-caret-right"></i> Update</a></li>
            <li><a href="extras.html"><i class="fa fa-caret-right"></i> Delete</a></li>
            <li><a href="extras.html"><i class="fa fa-caret-right"></i> Manage</a></li>
          </ul>
        </li>
